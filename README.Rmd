...
As mentioned above.
You are able to convert also data without "sub-" or "ses-" foldernames with the BIDSconvertR.

You are asked, if your subject- and session-ID's are fine, or if you want to edit them.
If your data was alread acquired with clear subject- and session-ID's you can skip this procedure by selecting:
...
2 - You are asked, if you want to delete temporary images from your hard drive.
